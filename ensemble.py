...
if __name__ == "__main__":
    ...
    with open("/ssd_scratch/cvit/sai.shashank/ensemble_ucla/body.pkl", 'rb') as r1:
        r1 = list(pickle.load(r1).items())

    with open("/ssd_scratch/cvit/sai.shashank/ensemble_ucla/hands.pkl", 'rb') as r2:
        r2 = list(pickle.load(r2).items())

    with open("/ssd_scratch/cvit/sai.shashank/ensemble_ucla/legs.pkl", 'rb') as r2:
        r2 = list(pickle.load(r2).items())
